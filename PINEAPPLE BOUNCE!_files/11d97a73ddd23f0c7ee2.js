! function (e) {
  ...
  "./source/js/wobbler.js": function (e, t, n) {
    ...
    for (a.setAttribute("id", "wobble"), a.setAttribute("class", "btn italic"), a.innerText = "🍍🍍🍍🍍 Bounce!", document.body.appendChild(a), o = a.firstChild.nodeValue; a.childNodes.length;) a.removeChild(a.childNodes[0]);
